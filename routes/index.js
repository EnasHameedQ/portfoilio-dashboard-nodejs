...
var personalInfoModel = require('../models/personalInfo');
const app = express();


/* GET home page. */
router.get('/', forwardAuthenticated, function(req, res, next) {
    res.render('index', { title: 'Enas Alqaadi' });
});
/* GET dashboard page. */
...
//## PersonalInfo methods (get,add,delete) ##//

//Add new personalInfo to the view in the data tables section
router.post('/add_personalInfo', function(req, res, next) {

    var personalInfoDetails = new personalInfoModel({
        personalInfo: req.body.personalInfo,
        date: req.body.date,
        university: req.body.university,
    });

    personalInfoDetails.save();
    req.flash('personalInfo-message', 'تم الاضافة بنجاح!');
...
router.post('/edit_personalInfo', function(req, res, next) {
    var item = {
        personalInfo: req.body.personalInfo,
        date: req.body.date,
        university: req.body.university
    ...
    req.flash('personalInfo-message-edit', 'تم التعديل بنجاح!');
...
router.get('/delete_personalInfo/:id', function(req, res, next) {
    personalInfoModel.deleteOne({ "_id": req.params.id },
        function(err, result) {
            console.log("item deleted");
        })
    req.flash('personalInfo-message-delete', 'تم الحذف!');
